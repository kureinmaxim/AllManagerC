# Инструкции по сборке AI Manager

Этот документ содержит подробные инструкции по созданию приложения AI Manager для macOS.
...
Данные пользователя (AI сервисы, ключи шифрования, загрузки) сохраняются в стандартных местах macOS:
- **Данные приложения**: `~/Library/Application Support/AiManager/`
- **Конфигурация**: `config.json` в папке приложения
- **Зашифрованные данные**: `data/ai_services.json.enc`
